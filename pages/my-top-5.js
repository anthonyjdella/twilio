                ...
                <article>
                    <ol>
                        ...
                        <p>
                            ...
                            <i>it automates tedious tasks</i>, it was my first
                            blog post
                        </p>

                        <h2>What&apos;s it about?</h2>
                        <p>
                            Tutorial about developing an automated script to
                            search & notify you of new job postings. Using
                            Node.js
                        </p>
                        ...
                        <p>
                            It solves a problem, it teaches developers,
                            <i> it helps scale blog-style websites</i>, it was
                            fun to implement
                        </p>

                        <h2>What&apos;s it about?</h2>
                        <p>
                            Tutorial to help developers scale their personal
                            blog by adding search functionality. Using Algolia
                            and Hugo.
                        </p>
                        ...
                        <h2>Why I like it</h2>
                        <p>
                            It has over 700 reactions & 60 comments, it brings
                            awareness to software licensing and open source,
                            <i> the topic impacts millions of developers</i>
                        </p>

                        <h2>What&apos;s it about?</h2>
                        <p>
                            A popular developer purposely introduced a bug into
                            his software, which cascaded to thousands of other
                            software.
                        </p>
                        ...
                        <h2>What&apos;s it about?</h2>
                        <p>
                            I explain why using a developer-specific font can
                            improve your productivity and health.
                        </p>
                        ...
                        <li className={stylesTop5.listItem}>
                            <Link href="https://anthonydellavecchia.com/blog/mongodb-atlas-hackathon/">
                                <a
                                    ...
                                    target="_blank"
                                >
                                    Helping Developers Solve a Compatibility
                                    Issue
                                </a>
                            </Link>
                        </li>
                        ...
                        <p>
                            I learned a lot,{" "}
                            <i>
                                it helps other developers wanting to solve a
                                similar problem
                            </i>
                        </p>
                        ...
                        <h2>What&apos;s it about?</h2>
                        <p>
                            Django doesn&apos;t support MongoDB, so I explain a
                            workaround for it. Using PyMongo, a Python
                            distribution.
                        </p>
